# Comprehensive evaluation script for all 4 ReGAIN evaluation scenarios
...
def save_results_summary(all_results, output_file="evaluation_results/evaluation_summary.txt"):
    ...
    with open(output_file, "w") as f:
        f.write("="*80 + "\n")
        f.write("  ReGAIN Evaluation Results Summary\n")
        f.write("="*80 + "\n\n")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("  ReGAIN Comprehensive Evaluation - All 4 Scenarios")
    print("="*70)
    ...
    print("="*70)
    print("\nGenerated files:")
    print("  - 8 visualization files (4 confusion matrices + 4 ROC curves)")
